...
@Using (Html.BeginForm("SospendiAttività", "Brighetti_Operatori", Nothing, FormMethod.Post, New With {.class = "ModalForm"}))
    @Html.AntiForgeryToken()

    @<div class="form-horizontal">
        @Html.ValidationSummary(True, "", New With {.class = "text-danger"})
        @Html.HiddenFor(Function(model) model.IdAttività)
        <p style="text-align: center;">Vuoi sospendere la seguente attività "<b>@Model.NomeAttività</b>"? Clicca su Salva per sospendere l'attività.</p>
