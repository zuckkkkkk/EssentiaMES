...
@Using (Html.BeginForm("Create", "Brighetti_Articolo", Nothing, FormMethod.Post, New With {.class = "ModalForm"}))
    ...
    <div class="row">
        ...
        <div class="col-6">
            @Html.LabelFor(Function(model) model.DescrizioneArticolo, htmlAttributes:=New With {.class = "control-label col-md-12"})
    ...
    <div class="row">
        ...
        <div class="col-6">
            ...
            @Html.DropDownList("FamigliaId", Nothing, htmlAttributes:=New With {.class = "form-control", .required = "required", .style = "max-width:none!important;"})
    ...
    <div class="row">
        <div class="col-12">
            @Html.LabelFor(Function(model) model.NoteArticolo, htmlAttributes:=New With {.class = "control-label col-md-12"})
