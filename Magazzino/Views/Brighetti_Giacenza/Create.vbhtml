...
@Using (Html.BeginForm("Create", "Brighetti_Giacenza", Nothing, FormMethod.Post, New With {.class = "ModalForm"}))
    ...
    @<div class="form-horizontal">
        ...
        <div class="row">
            <div class="col-md-6">
                @Html.LabelFor(Function(model) model.CodiceArticolo, htmlAttributes:=New With {.class = "control-label col-md-12"})
            ...
            <div class="col-md-6">
                @Html.LabelFor(Function(model) model.CodiceMagazzino, htmlAttributes:=New With {.class = "control-label col-md-12"})
        ...
        <div class="row">
            ...
            @Html.LabelFor(Function(model) model.QuantitàGiacenza, htmlAttributes:=New With {.class = "control-label col-md-4"})
                @Html.EditorFor(Function(model) model.QuantitàGiacenza, New With {.htmlAttributes = New With {.class = "form-control", .type = "number"}})
                @Html.ValidationMessageFor(Function(model) model.QuantitàGiacenza, "", New With {.class = "text-danger"})
            </div>
  
            <div class="col-md-6">
            @Html.LabelFor(Function(model) model.QuantitàSottoscorta, htmlAttributes:=New With {.class = "control-label col-md-6"})
                @Html.EditorFor(Function(model) model.QuantitàSottoscorta, New With {.htmlAttributes = New With {.class = "form-control", .type = "number"}})
