...
Namespace IdentityMigrations
    ...
    Public NotInheritable Partial Class RepartiIdentity
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(RepartiIdentity))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202307111623178_RepartiIdentity"
            End Get
        End Property
