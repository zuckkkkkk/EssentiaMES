...
Namespace BrighettiMigrations
    ...
    Public NotInheritable Partial Class QtaDaProdurre
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(QtaDaProdurre))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202307131036201_QtaDaProdurre"
            End Get
        End Property
