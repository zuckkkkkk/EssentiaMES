...
Namespace BrighettiMigrations
    ...
    Public NotInheritable Partial Class idMacchinaMagazzino
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(idMacchinaMagazzino))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202308161308267_idMacchinaMagazzino"
            End Get
        End Property
