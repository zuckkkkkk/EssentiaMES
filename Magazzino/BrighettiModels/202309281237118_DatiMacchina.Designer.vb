...
Namespace BrighettiMigrations
    ...
    Public NotInheritable Partial Class DatiMacchina
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(DatiMacchina))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202309281237118_DatiMacchina"
            End Get
        End Property
