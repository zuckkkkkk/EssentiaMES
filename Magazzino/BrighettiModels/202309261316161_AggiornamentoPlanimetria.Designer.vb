...
Namespace BrighettiMigrations
    ...
    Public NotInheritable Partial Class AggiornamentoPlanimetria
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(AggiornamentoPlanimetria))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202309261316161_AggiornamentoPlanimetria"
            End Get
        End Property
