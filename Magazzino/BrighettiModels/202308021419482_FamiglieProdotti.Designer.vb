...
Namespace BrighettiMigrations
    ...
    Public NotInheritable Partial Class FamiglieProdotti
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(FamiglieProdotti))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202308021419482_FamiglieProdotti"
            End Get
        End Property
