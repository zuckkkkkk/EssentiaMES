...
Namespace BrighettiMigrations
    ...
    Public NotInheritable Partial Class DocumentiNote
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(DocumentiNote))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202308161853407_DocumentiNote"
            End Get
        End Property
