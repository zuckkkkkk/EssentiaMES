...
Namespace BrighettiMigrations
    ...
    Public NotInheritable Partial Class Lottiultipli
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(Lottiultipli))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202309241447262_Lottiultipli"
            End Get
        End Property
