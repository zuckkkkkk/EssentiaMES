...
Namespace BrighettiMigrations
    ...
    Public NotInheritable Partial Class UpdateProcedure
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(UpdateProcedure))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202308141914347_UpdateProcedure"
            End Get
        End Property
