...
Namespace BrighettiMigrations
    ...
    Public NotInheritable Partial Class TipoAttività
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(TipoAttività))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202308161303467_TipoAttività"
            End Get
        End Property
