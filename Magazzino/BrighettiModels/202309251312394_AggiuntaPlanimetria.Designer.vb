...
Namespace BrighettiMigrations
    ...
    Public NotInheritable Partial Class AggiuntaPlanimetria
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(AggiuntaPlanimetria))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202309251312394_AggiuntaPlanimetria"
            End Get
        End Property
