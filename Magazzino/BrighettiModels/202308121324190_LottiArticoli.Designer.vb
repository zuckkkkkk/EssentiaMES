...
Namespace BrighettiMigrations
    ...
    Public NotInheritable Partial Class LottiArticoli
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(LottiArticoli))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202308121324190_LottiArticoli"
            End Get
        End Property
