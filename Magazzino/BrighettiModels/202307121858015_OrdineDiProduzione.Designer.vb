...
Namespace BrighettiMigrations
    ...
    Public NotInheritable Partial Class OrdineDiProduzione
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(OrdineDiProduzione))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202307121858015_OrdineDiProduzione"
            End Get
        End Property
