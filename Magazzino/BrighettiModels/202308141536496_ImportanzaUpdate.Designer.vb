...
Namespace BrighettiMigrations
    ...
    Public NotInheritable Partial Class ImportanzaUpdate
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(ImportanzaUpdate))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202308141536496_ImportanzaUpdate"
            End Get
        End Property
