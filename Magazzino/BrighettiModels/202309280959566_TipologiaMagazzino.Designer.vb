...
Namespace BrighettiMigrations
    ...
    Public NotInheritable Partial Class TipologiaMagazzino
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(TipologiaMagazzino))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202309280959566_TipologiaMagazzino"
            End Get
        End Property
