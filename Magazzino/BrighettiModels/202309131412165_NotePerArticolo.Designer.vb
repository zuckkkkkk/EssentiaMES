...
Namespace BrighettiMigrations
    ...
    Public NotInheritable Partial Class NotePerArticolo
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(NotePerArticolo))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "202309131412165_NotePerArticolo"
            End Get
        End Property
