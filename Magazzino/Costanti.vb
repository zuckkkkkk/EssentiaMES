Public Module Costanti
    ...
    Public Const WebAppVersion As String = "0.1.0"
    Public Const WebAppVersionDateBuild As Date = #10/22/2023#
    Public Const WebAppVersionDateRelease As Date = #10/22/2023#
